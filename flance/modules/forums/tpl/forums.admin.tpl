<!-- BEGIN: MAIN -->
<br>MAIN modules forums.admin.tpl start<br>
		<h2>{PHP.L.Forums}</h2>
...
<!-- BEGIN: ADMIN_FORUMS_ROW_USER -->
				<br>ADMIN_FORUMS_ROW_USER modules forums.admin.tpl start<br>
				<tr>
				...
				<br>ADMIN_FORUMS_ROW_USER modules forums.admin.tpl end<br>
<!-- END: ADMIN_FORUMS_ROW_USER -->
			</table>
		</div>
		<br>MAIN modules forums.admin.tpl end<br>
<!-- END: MAIN -->
