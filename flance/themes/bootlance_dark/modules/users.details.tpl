	...
	<div class="span9">
		...
		<div class="tabbable">
			<ul class="nav nav-tabs">
				...
				<li<!-- IF {PHP.tab} == 'reviews' --> class="active"<!-- ENDIF -->><a href="{USERS_DETAILS_REVIEWS_URL}#tab_reviews" data-toggle="tab">{PHP.L.projects_reviews} {USERS_DETAILS_REVIEWS_COUNT}</a></li>
				<!-- ENDIF -->
			</ul>
		</div>
